...
int main(int argc, char** argv)
{
    ...
    args.addArgument("plugin").setHelp("plugin", "animal plugin name").addOption("plugin-dir", ".").setHelp("plugin-dir", "plugin directory to use", "DIR").setHelp("Displays info about given road.").parse(argc, argv);
    ...
    std::unique_ptr<AbstractRoad> road = manager.instance(args.value("plugin"));
